...
from nanorollout.harness.agents.shared.installed_agent_factory import build_installed_agent
...
from nanorollout.harness.agents.swe.openhands.prompts import build_core_user_prompt, build_lite_user_prompt
from nanorollout.runner import TaskRunRequest, TaskSpec

from .adapter import AgentBuilder, AgentRunner, ResultHook, SweTaskSpec, TaskBuilder, run_swe_agent
...
def _build_oh_lite_agent(
    ...
    return CodeActLiteAgent(environment=env_obj, config=_build_agent_config(task, request))
...
run_installed_claude_code = _make_swe_runner(_installed_spec("claude-code", "run_installed_claude_code"))
run_installed_qwen_code = _make_swe_runner(_installed_spec("qwen-code", "run_installed_qwen_code"))
run_installed_opencode = _make_swe_runner(_installed_spec("opencode", "run_installed_opencode"))
