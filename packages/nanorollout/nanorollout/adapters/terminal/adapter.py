...
from nanorollout.runner import TaskAdapter, TaskRunRequest, TaskSpec, require_args, resolve_completed_status, run_task
...
class TerminalTaskSpec:
    ...
    def from_request(cls, request: TaskRunRequest) -> "TerminalTaskSpec":
        ...
        require_args(args, ("env_timeout", "create_timeout", "max_iterations"), "Terminal task")
        return cls(
