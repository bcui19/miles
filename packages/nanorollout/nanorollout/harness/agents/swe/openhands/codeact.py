...
class CodeActAgent(BaseAgent):
    ...
    def __init__(
        ...
        self._tools = tools or build_tools(workspace_mount_path_in_sandbox=getattr(environment, "workspace_dir", None))
    ...
    def get_tools_schema(self) -> list[dict[str, Any]]:
        ...
        use_short_description = any(substr in self.config.model for substr in short_desc_model_substrs)
        schemas = [tool.to_openai_schema(use_short_description=use_short_description) for tool in self.tools]
        return schemas
