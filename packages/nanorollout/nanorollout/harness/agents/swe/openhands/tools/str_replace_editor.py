"""Editor tool implementation for OpenHands agents."""
...
def _get_workspace_mount_path_from_env(runtime_type: str | None = None) -> str:
    ...
    For local and CLI runtimes, returns the host path from SANDBOX_VOLUMES.
...
class EditorTool(BaseTool):
    ...
    def __init__(
        ...
        self._workspace_mount_path_in_sandbox = workspace_mount_path_in_sandbox
        ...
        return [
            ...
            ToolParameter(
                ...
                description=(
                    ...
                    f"`{self._workspace_mount_path_in_sandbox}/file.py` or "
                    f"`{self._workspace_mount_path_in_sandbox}`."
                ),
                required=True,
            ),
            ToolParameter(
